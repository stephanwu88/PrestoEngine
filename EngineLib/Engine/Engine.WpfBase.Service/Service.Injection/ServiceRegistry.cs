...
namespace Engine.WpfBase
{
    ...
    public partial class ServiceRegistry
    {
        ...
        /// <summary> 获取服务 若返回是空则表示没有注入 </summary>
    ...
    public partial class ServiceRegistry : IServiceProvider
    {
        ...
        public static ServiceRegistry Instance
        {
            get
            {
                ServiceRegistry __instance;

                if ((__instance = ServiceRegistry._instance) == null)
                {
                    __instance = (ServiceRegistry._instance = new ServiceRegistry());
                }
                return __instance;
            }
        }
        ...
        private TClass MakeInstance<TClass>()
        {
            ...
            {
                return (TClass)((object)constructor.Invoke(this._emptyArguments));
            }
