...
namespace Engine.WpfControl
{
    internal static class ShadowInfo
    {
        ...
        static ShadowInfo()
        {
            var resourceDictionary = new ResourceDictionary { Source = new Uri("pack://application:,,,/Engine.WpfControl;component/Custom/Control/Dialog/Shadows.xaml", UriKind.Absolute) };
