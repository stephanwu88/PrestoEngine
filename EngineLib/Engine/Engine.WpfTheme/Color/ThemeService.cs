...
namespace Engine.WpfTheme
{
    ...
    public class ThemeService : NotifyObject
    {
        ...
        public static readonly Uri DarkThemeSource = new Uri("/Engine.WpfBase;component/Theme/Color/DarkThemeResource.xaml", UriKind.Relative);

        /// <summary> 浅颜色主题 </summary>
        public static readonly Uri LightThemeSource = new Uri("/Engine.WpfBase;component/Theme/Color/LightThemeResource.xaml", UriKind.Relative);

        /// <summary> 灰色主题 </summary>
        public static readonly Uri GrayThemeSource = new Uri("/Engine.WpfBase;component/Theme/Color/GrayThemeResource.xaml", UriKind.Relative);

        /// <summary> Accent主题 </summary>
        public static readonly Uri AccentThemeSource = new Uri("/Engine.WpfBase;component/Theme/Color/AccentThemeResource.xaml", UriKind.Relative);

        public static ThemeService Current = new ThemeService();

        static readonly Uri LanguageChineseSource = new Uri("/Engine.WpfBase;component/Resources/zh-cn.xml", UriKind.RelativeOrAbsolute);
        static readonly Uri LanguageEnglishSource = new Uri("/Engine.WpfBase;component/Resources/en-us.xml", UriKind.RelativeOrAbsolute);
    ...
    /// <summary> 说明</summary>
    public class AccentColorSource : NotifyObject
    {
        #region - 属性 - 
