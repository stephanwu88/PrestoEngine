                ...
                switch (info.FieldType.Name)
                {
                    ...
                    case "Double":
                        ...
                        info.SetValue(structValue, Real.FromByteArray(new byte[] { bytes[(int)numBytes],
                                                                           ...
                                                                           bytes[(int)numBytes + 2],
                                                                           bytes[(int)numBytes + 3] },
                                                                           SystemDefault.SiemensByteOrder32));
                        numBytes += 4;
                        break;
                    default:
            ...
            foreach (System.Reflection.FieldInfo info in infos)
            {
                ...
                switch (info.FieldType.Name)
                {
                    ...
                    case "Byte":
                        ...
                        break;
                    case "Int16":
                        bytes2 = Int.ToByteArray((Int16)info.GetValue(structValue), SystemDefault.SiemensByteOrder16);
                        break;
                    case "UInt16":
                        bytes2 = Word.ToByteArray((UInt16)info.GetValue(structValue), SystemDefault.SiemensByteOrder16);
                        break;
                    case "Int32":
                        bytes2 = DInt.ToByteArray((Int32)info.GetValue(structValue), SystemDefault.SiemensByteOrder32);
                        break;
                    case "UInt32":
                        bytes2 = DWord.ToByteArray((UInt32)info.GetValue(structValue), SystemDefault.SiemensByteOrder32);
                        break;
                    case "Double":
                        bytes2 = Real.ToByteArray((double)info.GetValue(structValue), SystemDefault.SiemensByteOrder32);
                        break;
                }
                if (bytes2 != null)
                {
