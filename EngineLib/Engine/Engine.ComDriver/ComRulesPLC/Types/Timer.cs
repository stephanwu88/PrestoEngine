...
namespace Engine.ComDriver.Types
{
    ...
    public static class Timer
    {
        ...
        public static double FromByteArray(byte[] bytes)
        {
            ...
            string txt = sCommon.ValToBinString(value);
            wert = sCommon.BinStringToInt32(txt.Substring(4, 4)) * 100.0;
            wert += sCommon.BinStringToInt32(txt.Substring(8, 4)) * 10.0;
            wert += sCommon.BinStringToInt32(txt.Substring(12, 4));
