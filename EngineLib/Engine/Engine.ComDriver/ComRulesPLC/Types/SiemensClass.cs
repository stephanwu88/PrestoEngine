...
namespace Engine.ComDriver.Types
{
    ...
    /// </summary>
    public static class SiemensClass
    {
        ...
        private static void ToBytes(object propertyValue, byte[] bytes, ref double numBytes)
        {
            ...
            switch (propertyValue.GetType().Name)
            {
                ...
                case "Byte":
                    ...
                    break;
                case "Int16":
                    bytes2 = Int.ToByteArray((Int16)propertyValue, SystemDefault.SiemensByteOrder16);
                    break;
                case "UInt16":
                    bytes2 = Word.ToByteArray((UInt16)propertyValue, SystemDefault.SiemensByteOrder16);
                    break;
                case "Int32":
                    bytes2 = DInt.ToByteArray((Int32)propertyValue, SystemDefault.SiemensByteOrder32);
                    break;
                case "UInt32":
                    bytes2 = DWord.ToByteArray((UInt32)propertyValue, SystemDefault.SiemensByteOrder32);
                    break;
                case "Double":
                    bytes2 = Real.ToByteArray((double)propertyValue, SystemDefault.SiemensByteOrder32);
                    break;
                default:
