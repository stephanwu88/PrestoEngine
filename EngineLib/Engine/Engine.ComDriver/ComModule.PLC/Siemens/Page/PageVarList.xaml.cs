...
{
    /// <summary>
    /// PageVarList.xaml 的交互逻辑
    /// </summary>
    public partial class PageVarList : UserControl
    {
        public Window Owner;
        ...
        public PageVarList(ModelDriverItem DriverItem, ServerNode serverNode = null)
        {
            InitializeComponent();
            if (DriverItem == null)
        ...
        private void UpdateDefaultView()
        {
            ...
            CallResult _result = _DB.ExcuteQuery<ModelComPLC>(com);
        ...
        private void PageVarList_NodeUpdated(object arg1, EditMode arg2, ViewComPLC arg3)
        {
            if (arg3 == null)
                return;
            ...
            if (arg2 == EditMode.AddNew)
            {
                ...
                _result = _DB.ExcuteInsert<ViewComPLC>(arg3);
            }
            else if (arg2 == EditMode.Modify)
            {
                arg3.DriverToken = _DriverToken.MarkWhere();
                _result = _DB.ExcuteUpdate<ViewComPLC>(arg3);
            }
            if (_result.Fail)
            ...
            switch (strCmd)
            {
             case "CmdAdd":
                ...
                case "CmdEdit":
                    ...
                    ViewComPLC model = ColumnDef.ToEntity<ViewComPLC>(rowView.Row);
                ...
                case "CmdDel":
                    ...
                    model = ColumnDef.ToEntity<ViewComPLC>(rowView.Row);
                    ModelComPLC modelDel = new ModelComPLC() { ID = model.ID };
                    CallResult _result = _DB.ExcuteDelete<ModelComPLC>(modelDel);
                    if (_result.Fail)
                    {
                        string strErr = "删除失败!\r\n\r\n";
