...
{
    public class StartUpWithSystem
    {
        /// <summary>
        /// 快捷方式名称-任意自定义
        /// </summary>
        //private const string QuickName = "ShortCutOfStartUpProcess";
        private string QuickName = System.IO.Path.GetFileName(Process.GetCurrentProcess().MainModule.FileName);
