...
namespace Engine.MVVM.Messaging
{
    ...
    public interface IMessenger
    {
        ...
        /// <param name="action">The action that will be executed when a message
        /// of type TMessage is sent.</param>
        void SingleRegister<TMessage>(object recipient, Action<TMessage> action);
        ...
        /// <param name="action">The action that will be executed when a message
        /// of type TMessage is sent.</param>
        void SingleRegister<TMessage>(object recipient, object token, Action<TMessage> action);
        ...
        /// <param name="action">The action that will be executed when a message
        /// of type TMessage is sent.</param>
        void SingleRegister<TMessage>(object recipient, bool receiveDerivedMessagesToo, Action<TMessage> action);
