...
namespace Engine.SharpZipLib
{
    public class SharpZipLib
    {
        ...
        public bool Compression(string fileToZip, string zipedFile, string password = "")
        {
            bool result = false;
        ...
        private bool DeCompression(string fileToUnZip, string zipedFolder, string password = "")
        {
            bool result = true;
            FileStream fs = null;
